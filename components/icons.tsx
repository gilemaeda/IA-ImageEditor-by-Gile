...
export const MagicWandIcon: React.FC = () => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        <path d="M15 4V2" />
        <path d="M15 22v-2" />
        <path d="M12.24 6.76L13.66 5.34" />
        <path d="M10.59 13.41L2 22l4-4 3.41-3.41" />
        <path d="m22 2-4 4-3.41 3.41" />
        <path d="M19.76 17.24l1.42 1.42" />
        <path d="M4.24 8.76l-1.42-1.42" />
        <path d="M20 15h2" />
        <path d="M2 15h2" />
    </svg>
);
